        ...
        <md-card-content>
            ...
            <div class="md-layout-item md-size-33 md-small-size-100">
              <md-field>
                ...
                <md-select
                  ...
                  id="formaPagamento"
                  multiple
                  v-model="filter.forma_pagamento"
                >
                  <md-option value=""></md-option>
                  <md-option
            ...
            <div class="md-layout-item md-size-33 md-small-size-100">
              <md-field>
                ...
                >
                  <md-option value=""></md-option>
                  <md-option
                    v-for="categoria in categoriasSelect"
                    :value.sync="categoria.id"
                    :key="categoria.id"
          ...
          <div class="md-layout md-gutter">
            <div class="md-layout-item md-size-50 md-small-size-100">
              ...
              <md-field>
                <md-datepicker
                  name="dt_vencimento_inicial"
                  id="dt_vencimento_inicial"
                  v-model="filter.data_vencimento"
                />
              </md-field>
            </div>
            <div class="md-layout-item md-size-50 md-small-size-100">
              ...
              <md-field>
                <md-datepicker
                  name="dt_vencimento_final"
                  id="dt_vencimento_final"
                  v-model="filter.data_vencimento_ate"
                />
              </md-field>
            </div>
          </div>
          <div class="md-layout md-gutter">
            <div class="md-layout-item md-size-50 md-small-size-100">
              ...
              <md-field>
                <md-datepicker
                  name="dt_pagamento_inicial"
                  id="dt_pagamento_inicial"
                  v-model="filter.data_pagamento"
                />
              </md-field>
            </div>
            <div class="md-layout-item md-size-50 md-small-size-100">
              ...
              <md-field>
                <md-datepicker
                  name="dt_pagamento_final"
                  id="dt_pagamento_final"
                  v-model="filter.data_pagamento_ate"
                />
              </md-field>
            </div>
          </div>

<template>
  <div>
    <div>
      <md-toolbar
        :class="{ 'md-accent md-dense': error, 'md-primary md-dense': !error }"
        v-if="msgForm"
      >
    ...
    <form
      ...
      action="/"
      method="POST"
      @submit.prevent="registerDespesa()"
    >
            ...
            <div class="md-layout-item md-small-size-100">
              ...
              >
                ...
                <md-select
                  ...
                  v-model="$v.despesa.ID_FORMA_PAGAMENTO.$model"
                >
                  <md-option
                ...
                <md-button
                  class="md-icon-button md-primary"
                  @click="loadSelectFormasPagamento"
                >
            ...
            <div class="md-layout-item md-small-size-100">
              ...
              >
                ...
                <md-select
                  name="ID_FORNECEDOR"
                  id="ID_FORNECEDOR"
                  v-model="$v.despesa.ID_FORNECEDOR.$model"
                >
            ...
            <div class="md-layout-item md-small-size-100">
              <md-field>
                ...
                <md-input
                  ...
                  name="DESCONTO"
                  autocomplete="off"
                  v-model.number="despesa.DESCONTO"
                />
              </md-field>
            </div>
          </div>
            ...
            <div class="md-layout-item md-small-size-100">
              <md-field>
                ...
                <md-select
                  name="ID_CATEGORIA"
                  id="ID_CATEGORIA"
                  v-model="despesa.ID_CATEGORIA"
                >
                  <md-option
                    v-for="(categoria, index) in categoriasSelect"
                    :value="index"
                    :key="categoria.id"
            ...
            <div class="md-layout-item md-small-size-100">
              ...
              >
                ...
                <md-input
                  ...
                  name="TOTAL_PARCELAS"
                  autocomplete="off"
                  v-model.number="$v.despesa.TOTAL_PARCELAS.$model"
                  min="1"
                />
                <span
                  class="md-error"
            ...
            <div class="md-layout-item md-small-size-100">
              ...
              >
                <md-datepicker
                  name="DATA_COMPRA"
                  id="DATA_COMPRA"
                  v-model="$v.despesa.DATA_COMPRA.$model"
                >
...
export default {
  ...
  methods: {
    ...
    formatDate: function(dateFormat) {
      if (dateFormat) {
        typeof dateFormat == "object"
          ? (dateFormat = `${dateFormat.getFullYear()}-${dateFormat.getMonth() +
